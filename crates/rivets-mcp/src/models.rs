...
///
/// Update owns only descriptive fields and Priority/Kind. Workflow state,
/// Assignment, Labels, Notes, and relationships each have dedicated tools.
#[derive(Debug, Clone, Default, Serialize, Deserialize, JsonSchema)]
#[serde(deny_unknown_fields)]
...
/// Parameters shared by the `start` and `return_to_open` lifecycle tools.
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
pub struct LifecycleParams {
    /// The issue ID whose Workflow State should change.
    pub issue_id: String,
