...
- Added single-Epic Parentage with role-safe CLI and MCP set, clear, move, and show operations; Parentage enforces ownership and lifecycle invariants without affecting Blocked or Ready.
