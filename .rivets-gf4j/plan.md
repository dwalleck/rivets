...
| C — Slice 4 plus review fixes/log | 3,122 |
| **Summed increment diffs** | **5,922** |
| **Final cumulative base diff** | **5,228** |
...
- [x] Partition arithmetic includes the original 20% churn margin; the exact 5,228-line cumulative diff is split into three independently mergeable increments after the final size tripwire.
